...
#  window.del_all_rus()
$(document).on 'turbolinks:load', showroom_ready # Включаем при ajax обновлении страницы
#$(document).ready showroom_ready # Включаем при обычном обновлении страницы
# nested_finish
